...
def get_raw_data(file_path):
    ...
    np.save(save_path+"idt_test_data.npy", data)
    np.save(save_path+"idt_test_label.npy", label)
    
    return data, label

if __name__ == "__main__":
    file_path = "/data/chaoyi_he/Crossbar_Sim/idt_project/data/Test/dataset_seen_devices.h5"
